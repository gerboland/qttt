...
from .quantum_goff_board import QuantumGoffBoard

Action = typing.Union[int, typing.Tuple[int, int]]


class QuantumTicTacToe_Goff_Env(gym.Env):
    """
    Quantum TicTacToe - based on Goff's rules
    """
    ...
    def __init__(self, board_size: int) -> None:
        ...
        self.board = QuantumGoffBoard(board_size)
    ...
    def step(self, action: int):
        ...
        # Must collapse if a cycle of entangled states exist.
        # This is not a deliberate action, and makes game non-deterministic.
        if new_board.collapsible_cycles_exist():
            # print(new_board)
            # print("\nCollapse!\n")
            new_board.collapse_all_cycles()
    ...
    def board(self) -> QuantumGoffBoard:
        return self.board
